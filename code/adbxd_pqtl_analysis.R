...
saveRDS(adbxd_pqtl_ntg_months06,
        paste0("./data/pqtl/adbxd_pqtl_ntg_months06_a",slurm_array_id,".RDS"))
saveRDS(adbxd_pqtl_5xfad_months06,
        paste0("./data/pqtl/adbxd_pqtl_5xfad_months06_a",slurm_array_id,".RDS"))
saveRDS(adbxd_pqtl_ntg_months14,
        paste0("./data/pqtl/adbxd_pqtl_ntg_months14_a",slurm_array_id,".RDS"))
saveRDS(adbxd_pqtl_5xfad_months14,
        paste0("./data/pqtl/adbxd_pqtl_5xfad_months14_a",slurm_array_id,".RDS"))
