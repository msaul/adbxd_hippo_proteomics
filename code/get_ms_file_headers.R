...
raw_files_dir = "/projects/kaczorowski-lab/USERS/saulm/adbxd_proteomics/data/raw/ms_raw/"
...
write.table(raw_files_header, "/projects/kaczorowski-lab/USERS/saulm/adbxd_proteomics/data/raw/raw_ms_file_headers.tsv",
